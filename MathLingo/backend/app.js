...
//Convierte simbolos (<>) a texto para evitar scrips inyectados en inputs publicos
const xss = require('xss-clean');
//Evita que mandes mas de un parametro con signos como && 
const hpp = require('hpp');
//Elimina caracteres que puedan confundir al servidor en req.body, req.query y req.params (inyeccion noSQL y SQL)
//Es decir mandar caracteres que sean comandos SQL, esto puede hacer que pasen verificaciones
